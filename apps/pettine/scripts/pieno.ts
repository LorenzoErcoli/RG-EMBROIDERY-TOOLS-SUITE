...
//
//   npx esbuild apps/pettine/scripts/pieno.ts --bundle --format=esm --platform=node \
//     --alias:@rg/core=./packages/core/src/index.ts --outfile=apps/pettine/scripts/pieno.mjs
//   node --max-old-space-size=4096 apps/pettine/scripts/pieno.mjs <vettoriale.svg> <foto.bmp> [basi] [passo] [dMin] [dMax] [incl] [nettoMm]
