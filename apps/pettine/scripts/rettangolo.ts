...
//
//   npx esbuild apps/pettine/scripts/rettangolo.ts --bundle --format=esm --platform=node \
//     --outfile=apps/pettine/scripts/rettangolo.mjs
//   node apps/pettine/scripts/rettangolo.mjs
...
writeFileSync('apps/pettine/scripts/out/rettangolo.svg', svg, 'utf8');
console.log(`-> apps/pettine/scripts/out/rettangolo.svg  (${TW} x ${TH} mm)`);
