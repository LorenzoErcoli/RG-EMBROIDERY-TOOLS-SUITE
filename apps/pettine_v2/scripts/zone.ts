...
//
//   npx esbuild apps/pettine_v2/scripts/zone.ts --bundle --format=esm --platform=node \
//     --alias:@rg/core=./packages/core/src/index.ts --outfile=apps/pettine_v2/scripts/zone.mjs
//   node apps/pettine_v2/scripts/zone.mjs <file.svg> [gruppo]
