...
//
//   npx esbuild apps/pettine_v2/scripts/schema-passaggi.ts --bundle --format=esm --platform=node \
//     --outfile=apps/pettine_v2/scripts/schema-passaggi.mjs
//   node apps/pettine_v2/scripts/schema-passaggi.mjs
...
writeFileSync('apps/pettine_v2/scripts/out/schema-passaggi.svg',
...
console.log('-> apps/pettine_v2/scripts/out/schema-passaggi.svg');
