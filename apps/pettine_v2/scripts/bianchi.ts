...
//
//   npx esbuild apps/pettine_v2/scripts/bianchi.ts --bundle --format=esm --platform=node \
//     --alias:@rg/core=./packages/core/src/index.ts --outfile=apps/pettine_v2/scripts/bianchi.mjs
//   node --max-old-space-size=4096 apps/pettine_v2/scripts/bianchi.mjs <file.svg> [basi] [passo] [dMin] [dMax] [incl]
