...
//
//   npx esbuild apps/pettine_v2/scripts/gruppi.ts --bundle --format=esm --platform=node \
//     --alias:@rg/core=./packages/core/src/index.ts --outfile=apps/pettine_v2/scripts/gruppi.mjs
//   SOLO_BASI=1 node --max-old-space-size=6144 apps/pettine_v2/scripts/gruppi.mjs <blocchi.svg> <foto.bmp> [basi] [passo] [dMin] [dMax] [incl] [nettoMm] [sormNetto] [sormSfumato] [verso] [lisciaMm]
