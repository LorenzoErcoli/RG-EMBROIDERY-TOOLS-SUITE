...
//
//   npx esbuild apps/pettine_v2/scripts/provino.ts --bundle --format=esm --platform=node \
//     --outfile=apps/pettine_v2/scripts/provino.mjs
//   node apps/pettine_v2/scripts/provino.mjs
...
// --- FOGLIO 1: il pettine. Il TUO accanto al mio, per vedere se ho preso i numeri giusti --------
{
  ...
  const sorgente = readFileSync('apps/pettine_v2/fixtures/PUNTO-SFRANGIATO-CASUALE.svg', 'utf8');
