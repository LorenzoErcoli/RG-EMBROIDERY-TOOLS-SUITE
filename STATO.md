...
- **Struttura del pannello laterale**: direttiva chiesta all'agente `design-system`. Attrito noto: il pannello di pattern-grammar è stato ricostruito apposta *"fedele alla UI originale"*, e standardizzare le posizioni lo contraddice (lì l'import sagoma e la scelta colore stanno nel gruppo 05, in net-45 sono 01 e 02).
