...
- **Revisione dei parametri — 8 decisioni CHIUSE** → `REVISIONE-PARAMETRI.md` (tabella in testa). Implementazione in corso:
  ...
  3. [ ] **pattern-grammar** (il grosso): riordino pannello (01 Sagoma · 02 Colori e ruoli · 03 Formato · 04–07 gruppi · 08 Preset) + etichette + ⑤ larghezza esatta + ⑥ split `strokeWidth` (filo 0,1 + `constructionStrokeMm`) + ⑦ onda mm/gradi + ⑧ rinomina con **conversione preset**.
