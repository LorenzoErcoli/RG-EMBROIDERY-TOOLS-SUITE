...
**Rete di sicurezza comune:** `npm test` (616 asserzioni: le primitive del core più le invarianti di tutti i motori, su fixture sintetiche **e sugli SVG veri**), `npm run typecheck` (la build non controlla i tipi: vite usa esbuild) e `npm run build`. Tutti e tre girano in CI a ogni push.
